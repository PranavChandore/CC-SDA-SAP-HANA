...
print("================================================================================")
print(" ALIGNED ROOT CONTRACT QUERY FOR CONTRACT 00000000000000061742")
print("================================================================================")
...
SELECT 
    ...
    CASE 
        ...
        WHEN LOCATE(BINTOHEX(allo.ALLO_DATA), '4155444F5F52454E4557414C5F464C4147') > 0 
          OR LOCATE(BINTOHEX(allo.ALLO_DATA), '4155544F5F52454E4557414C5F464C4147') > 0 THEN 'AUTO_RENEWAL_FLAG'
