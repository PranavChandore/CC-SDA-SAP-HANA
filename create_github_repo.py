...
REPO_NAME = "sap-cc-grace-period-discovery"
...
try:
    with urllib.request.urlopen(req) as resp:
        ...
        print(f"[OK] Repository successfully created on GitHub!")
        print(f"     HTML URL : {repo_html_url}")
except urllib.error.HTTPError as e:
    if e.code == 422:
        print("[!] Repository already exists on GitHub. Pushing changes.")
...
if push_res.returncode == 0:
    print(f"\n✅ SUCCESS! Repository live on GitHub: {repo_html_url}")
