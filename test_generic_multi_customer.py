...
print("================================================================================")
print(" GENERIC SQL QUERY FOR MULTIPLE CUSTOMERS / SUBSCRIBERS")
print("================================================================================")

subscribers = ['0011111151', '0000073467', '0000634156', '0000006312']
...
WHERE sa.SUBSCRIBER IN ({subs_str})
ORDER BY sa.SUBSCRIBER, caco.EXT_ID, allo.OID;
"""

try:
    cur.execute(sql_multi)
    ...
    print(f"Error executing multi-subscriber SQL: {e}")
