...
print("================================================================================")
print(" TESTING DYNAMIC GRACE FREE PERIOD VALUE (NO HARDCODED 77) FOR MULTIPLE CUSTOMERS")
print("================================================================================")
...
SELECT DISTINCT
    ...
    -- 1. Fully Dynamic Grace Period Calculation (NO HARDCODING! Works for any 14, 30, 60, 77, 90 days)
    CASE 
