...
print("================================================================================")
print(" FINAL END-TO-END SQL QUERY (PURE SQL FOR SAP CC & ERP)")
print("================================================================================")
...
LEFT JOIN (
    ...
    WHERE EVENT_TYPE NOT LIKE '%COMMISSION%'
      AND PLAN_PRICE IS NOT NULL AND PLAN_PRICE <> '' AND PLAN_PRICE <> 'NaN'
    GROUP BY CON_ID
) evt 
...
try:
    ...
    print(f"Error executing final E2E SQL: {e}")
